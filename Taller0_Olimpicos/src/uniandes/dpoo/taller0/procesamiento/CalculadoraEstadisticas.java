...
public class CalculadoraEstadisticas
{
	...
	public Pais consultarPaisAtleta(String atleta)
	{
		Pais elPais=null;
		for (Pais p : paises)
		{
			List<Map<String, Object>> atletasPais= p.consultarAtletas();

			for (Map<String, Object> a : atletasPais)
			{
				if (a.get("nombre").equals(atleta))
					elPais= p;
			}	
